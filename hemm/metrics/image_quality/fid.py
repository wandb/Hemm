...
class FIDMetric(BaseImageQualityMetric):

    def __init__(
        self,
        fid_features: int = 2048,
        fid_reset_real_features: bool = True,
        ...
        self.stateful_fid_metric = FrechetInceptionDistance(
            feature=fid_features,
            reset_real_features=fid_reset_real_features,
            normalize=True,
        )
        self.config = {
            "fid_features": fid_features,
            "fid_reset_real_features": fid_reset_real_features,
