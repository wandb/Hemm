...
from hemm.metrics.image_quality import FIDMetric, LPIPSMetric, PSNRMetric, SSIMMetric
...
if __name__ == "__main__":
    ...
    # Add FID Metric
    fid_metric = FIDMetric(image_size=diffuion_evaluation_pipeline.image_size)
